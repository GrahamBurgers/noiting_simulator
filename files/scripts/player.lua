...
--[[
-- drop stains at a CONSISTENT RATE
if ComponentGetValue2(this, "mTimesExecuted") % 5 == 0 then
	EntityAddRandomStains(me, CellFactory_GetType("ns_unstainer"), 1)
end
]]--
...
if dummy ~= 0 then
	local dx, dy = EntityGetTransform(dummy)
	if dy - y > 80 then
		cy = cy - 70
	elseif y - dy > 15 then
		cy = cy + 70
