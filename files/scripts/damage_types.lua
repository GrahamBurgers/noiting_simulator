function ProjHit(proj_entity, projcomp, who, multiplier, x, y, who_did_it)
    ...
    if fire and on_fire then
        ComponentSetValue2(on_fire, "value_float", ComponentGetValue2(on_fire, "value_float") + ComponentGetValue2(fire, "value_float"))
        ComponentSetValue2(on_fire, "value_string", ComponentGetValue2(fire, "value_string"))
    end
end

function DoDamage(who, types, multiplier, who_did_it, proj_entity, x, y, do_percent_damage)
