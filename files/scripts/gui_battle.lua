...
return function()
	...
	if v.name and tonumber(GlobalsGetValue("NS_STORAGE_BOX_FRAME", "1")) == 0 then
	...
	local p_size = tonumber(GlobalsGetValue("NS_PORTRAIT_SIZE", "16"))
	p_file = "mods/noiting_simulator/files/gui/portraits/" .. p_file .. ".xml"
	...
	-- animated portrait
	GuiZSet(Gui3, 60)
	GuiImage(Gui3, id(), portraitx, portraity, p_file, 1, GUI_SCALE, GUI_SCALE, 0, p_type, p_anim)
	-- frame
	GuiZSet(Gui3, 55)
