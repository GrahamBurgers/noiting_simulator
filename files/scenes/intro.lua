SCENE = {
    ...
    {track = 1, text = [[You travelled all the way down here and collapsed just like that.
    I suppose mortality can be stressful.]]},
    {track = 1, text = [[Little Knower to Be... or, I suppose I should just call you 'Knower' now. Heh.]]},
    {track = 1, text = [[After all, it was your knowledge that brought peace to this world.]]},
    ...
    {track = 1, text = [[Regardless. You've got seven days to get to know the locals. Enjoy yourself, why don't you?]]},
    {track = 1, text = [[I wouldn't want to stress you further, after you've worked so hard for us all...]]},
    {track = 1, text = [[
Ah, you probably don't want to listen to me blather on much longer. Go on now.]]},
    {track = 1, text = [[The worm-tunnel to the east will take you to the surface. Jättimato will be glad to assist you.]]},
    {track = 1, text = [[When it gets dark, return here. There's a Kammi in the Holy Mountain west of here for you to rest in.]]},
    {track = 1, text = [[Farewell for now, Knower. Good luck on your journey.]]},
}