SCENE = {
    ...
    It just stares for a long moment... as if expecting something from you.]], ["behavior"] = "choice",
        ["choices"] = {
            {["name"] = "Mount", ["function"] = function() SetScene(nil, nil, nil, 1) ["location"] = "right" end},
            {["name"] = "Back off", ["function"] = function() SetScene(nil, nil, nil, 2) ["location"] = "left" end},
        }},
    ...
    {["track"] = 1, ["text"] = [[You take a deep breath, take a step forward, brace yourself, and...]]},
    {["track"] = 1, ["text"] = [[...Before you know it, you're on the worm's back.
    From here, the blue hair that coats its body actually feels quite soft.]]},
    {["track"] = 1, ["text"] = [[Then, a quiet rumbling... as the worm begins gaining speed.
    Slowly at first, but then faster and faster, until the world begins to blur around you.]]},
    {["track"] = 1, ["text"] = [[Before long, you find yourself desperately clutching onto the worm's bow with both hands.
    You stay like that for what seems like an eternity, holding on for dear life, and then...]]},
    -- awesome gfx here
    {["track"] = 1, ["text"] = [[Sunlight covers your body and fills your eyes as the worm breaks through to the surface.]]},
    {["track"] = 1, ["text"] = [[By the time you realize you're in the air, you've already landed, with a loud thump that nearly knocks the wind out of you.]]},
    {["track"] = 1, ["text"] = [[You're still moving rather fast, skating along the grassy surface now, kicking up dirt and dust as you go.
    Buildings come into view, and the worm finally begins to slow down upon seeing them.]]},
    {["track"] = 1, ["text"] = [[It takes a bit of effort to hold down your nausea for the rest of the trip... but you manage.
    Eventually, it slows to a stop, causing a cloud of dust to billow out around you.
    You dismount slowly, feeling somewhat dizzy.]]},
    {["track"] = 1, ["text"] = [[And yet, before you've even had the time to get your bearings...
