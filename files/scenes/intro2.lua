...
{track = 3, texts = {{text = table.concat({[["]], Name_caps, [[! You're here!", they squeal, before releasing you and taking a step back.]]})}}},
{track = 3, texts = {{text = table.concat({[[You realize then who it is - it's Parantajahiisi, the healer, looking better than ever;
]], a["Their"], [[ armor is freshly polished, shining a radiant pink.]]})}}},
{track = 3, texts = {{text = {[["Hi! I've been waiting for you, I-"]]}}}},
